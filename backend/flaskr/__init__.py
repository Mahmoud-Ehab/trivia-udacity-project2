...
def create_app(test_config=None):
  ...
  def post_question():
      try:
          ...
          new_question = Question(body['question'], body['answer'], int(body['category']), int(body['difficulty']))
          new_question.insert()
  ...
  def play_quiz():
      try:
          ...
          category = Category.query.get(category_id)
          questions = category.questions if category else Question.query.all()

          # Initialize random question with id None
          rand_question = {'id': None}

          while rand_question['id'] in prev_questions_ids or rand_question['id'] is None:
              ...
              rand_question = questions[rand_num].format()
